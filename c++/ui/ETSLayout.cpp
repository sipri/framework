...
// 2000/05/31   Fix for PropertySheets with PSH_WIZARDHASFINISH [Th?mi]
...
/////////////////////////////////////////////////////////////////////////////
// Behandlungsroutinen f? Nachrichten ETSLayoutPropertyPage 
...
/////////////////////////////////////////////////////////////////////////////
// Behandlungsroutinen f? Nachrichten ETSLayoutPropertySheet 
...
void ETSLayoutPropertySheet::Resize(int cx, int cy)
{
	if( abs(cx) + abs(cy) > 0 && m_RootPane.IsValid() ) 
	{
		...
		// Fix for PSH_WIZARDHASFINISH [Th?mi]
...
void ETSLayoutPropertySheet::AddButtons(CPane paneBottom)
{
	...
	{
		// Prevent movement of finish button, if it is not shown explicitly [Th?mi]
		if( IsWizard() 
